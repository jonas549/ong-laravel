...
<section class="reveal" style="max-width:900px;margin:0 auto;padding:20px 40px 72px;text-align:center;">
    <p class="dato-editable" style="font-size:24px;font-weight:700;line-height:1.35;letter-spacing:-.01em;margin:0 auto 34px;max-width:22ch;color:var(--ink);">
    ...
    <p class="dato-editable" style="font-size:24px;font-weight:700;line-height:1.35;letter-spacing:-.01em;margin:30px 0 0;color:var(--ink);">{{ $seccion->texto('texto_final', $b) }}</p>
</section>
