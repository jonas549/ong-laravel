...
<section id="top" style="position:relative;overflow:hidden;background:#e9c7e0;">
    ...
    <div style="position:relative;z-index:2;max-width:900px;margin:0 auto;padding:72px 40px 210px;text-align:center;">
        ...
        <div style="position:relative;width:470px;max-width:100%;margin:22px auto 0;">
            ...
            <a href="{{ $seccion->enlace('cta_enlace', $b) ?: '#voluntariado' }}" class="hero-cta dato-editable" style="position:absolute;left:50%;bottom:64px;transform:translateX(-50%);background:var(--naranjo);color:#fff;font-weight:700;font-size:17px;padding:13px 30px;border-radius:999px;box-shadow:0 12px 26px -12px rgba(229,114,0,.85);">
