...
| `hora-y-campos.mjs` | el selector de hora: un `<select>` con las 24 en punto en AM/PM, vacío y abriendo en las 9:00 AM (B4, escritorio y teléfono); la pregunta de los voluntarios en el paso de la actividad, y la tabla de inscritos sin la columna «Estado» (**necesita Chrome**) |
| `sexta-wizard.mjs` | sexta tanda, B1–B3, B5 y B6: qué pasos se salta el wizard con sesión, el paso 3 casi vacío de una ficha sin tipo, cambiar de cuenta sin salir, el logo que no obliga a «Otra» ni en el teléfono, y subirlo desde «Mi perfil». Crea y borra dos organizadores (**necesita Chrome**; no contra producción) |
| `sexta-formulario.mjs` | B7 y B8: los títulos de campo frente a su ayuda, y el botón de calendario del teléfono (**necesita Chrome**; sólo lectura) |
| `sexta-home.mjs` | C1–C6: el botón del hero sin recortar de 320 a 1440 px, el logo del pie, los enlaces de YouTube y de la Comunidad, «Quiero ser voluntario» y las tarjetas del listado (**necesita Chrome**; sólo lectura, vale contra producción) |
| `sexta-correcciones.mjs` | las correcciones del 22/09: el logo obligatorio por tipo y por ancho (wizard y crear cuenta), las tarjetas sin enlace y la redirección del paso 1. Toca ajustes y tarjetas: **no contra producción** |
